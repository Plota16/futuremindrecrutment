...
from .. import config
from ..constants import OMDB_POOL_SIZE, OMDB_RETRY_BACKOFF, OMDB_RETRY_STATUSES, OMDB_RETRY_TOTAL
...
def _build_session() -> requests.Session:
    ...
    adapter = HTTPAdapter(pool_connections=OMDB_POOL_SIZE, pool_maxsize=OMDB_POOL_SIZE, max_retries=_RETRY)
